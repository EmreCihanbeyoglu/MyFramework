...
import com.tester.Drivers.Driver;
...
public class BrowserUtils {
    ...
    /**
     * wait until specified attribute to be specified value
     * @param webElement
     * @param attribute
     * @param value
     * @param timeInSec
    ...
    public static void waitForAttributeToBe(WebElement webElement, String attribute, String value, int timeInSec ){
        WebDriverWait wait = new WebDriverWait(Driver.get(),timeInSec);
        wait.until(ExpectedConditions.attributeToBe(webElement,attribute,value));
    }


    /**
     * wait until an element with specified locator becomes invisible
     * @param locator
     * @param timeout
     * @return
     */
    ...
    /**
     * keyDown methodu ile icine pass edilen tusa basili tutulurken devamindaki islem yapilir
     */
    ...
    /**
     * keyDown methodu ile icine pass edilen tusa basili tutulurken devamindaki islem yapilir
     * Fakat bu method ile calisirken yeni bir sekme acti. Normalde beklemiyordum.
     * Eger ayni sekilde yaparsa jScript ile yapabilirsin bu islemi
     */
    ...
    /**
     * adjust the page zoom ratio. But be aware of selenium cannot locate founded webelement after this change
